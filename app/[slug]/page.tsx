        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
          <Card className="bg-gradient-to-br from-brand-light to-brand-gradient-to border-brand-border-light">
            <CardContent className="p-4 md:p-6 text-center">
              ...
              <div className="text-sm text-gray-600 dark:text-gray-400">Questions on Test</div>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gradient-to-br from-brand-light to-brand-gradient-to border-brand-border-light">
            <CardContent className="p-4 md:p-6 text-center">
              ...
              <div className="text-sm text-gray-600 dark:text-gray-400">Min. Permit Age</div>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gradient-to-br from-brand-light to-brand-gradient-to border-brand-border-light">
            <CardContent className="p-4 md:p-6 text-center">
              ...
              <div className="text-sm text-gray-600 dark:text-gray-400">Correct to Pass</div>
            </CardContent>
          </Card>
        </div>
