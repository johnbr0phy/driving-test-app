    ...
    <div className="space-y-4">
      ...
      {!isPremium && lockedCount > 0 && (
        <div className="relative">
          {/* Blurred preview */}
          <div className="space-y-3 overflow-hidden max-h-40 blur-sm pointer-events-none select-none">
              ...
              <Card key={q.questionId} className="border-gray-100">
                <CardContent className="p-4">
                  <div className="flex items-start gap-3">
                    ...
                    <span className="ml-auto text-sm font-bold text-red-500 shrink-0">
                      {q.errorRate}%
                    </span>
                  </div>
                </CardContent>
