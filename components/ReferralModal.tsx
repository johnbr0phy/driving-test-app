      ...
      <DialogContent className="sm:max-w-md p-6 gap-0">
        ...
        {isGuest ? (
          ...
          <>
            ...
            {/* Personal link preview - click anywhere to copy */}
            {referralCode && (
              <button
                type="button"
                onClick={handleCopy}
                className="w-full text-left mb-4 rounded-lg bg-gray-50 border border-gray-100 px-3 py-2 hover:bg-gray-100 hover:border-gray-200 transition-colors group"
                aria-label={t("referral.copyLinkSecondary")}
              >
                <div className="flex items-center justify-between gap-2 mb-1">
                  <div className="text-[10px] font-semibold text-gray-400 uppercase tracking-wider">
                    {t("referral.yourLinkLabel")}
                  </div>
                  <div className="flex items-center gap-1 text-[10px] font-semibold uppercase tracking-wider text-gray-400 group-hover:text-gray-600 transition-colors">
                    {copied ? (
                      <>
                      ...
                      <>
                        ...
                        {t("referral.copyLinkSecondary")}
                      </>
                    )}
                  </div>
                </div>
                <div className="text-xs text-gray-700 font-mono break-all text-left">{link}</div>
              </button>
            )}
