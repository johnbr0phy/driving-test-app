export const en = {
  ...
  dashboard: {
    ...
    heroSub2: "Progress. Your examiner might only sigh twice.",
    heroTitle3: "Getting Suspiciously Competent",
    heroSub3: "Three done. People are starting to talk.",
    heroTitle4: "Building Momentum",
    heroSub4: "Four down. You're picking up speed.",
    heroTitle5: "Halfway There",
    heroSub5: "The glass is half full. Of road knowledge.",
  ...
  paywall: {
    ...
    benefits: [
      "Unlock Training Set 4",
      "Unlock Practice Test 4",
