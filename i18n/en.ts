export const en = {
  ...
  dashboard: {
    ...
    heroSub0: "...and you'll be ready to ace your DMV test.",
    heroTitle1: "Good start — 1 of 8 done",
    heroSub1: "Keep going. Each step builds real knowledge.",
    heroTitle2: "2 of 8 done",
    heroSub2: "You're making progress. Pick another and keep going.",
    heroTitle3: "Nearly halfway there",
    heroSub3: "3 down. Head back and knock out another one.",
    heroTitle4: "Halfway there",
    heroSub4: "4 of 8 complete. You're building serious knowledge.",
    heroTitle5: "More than halfway",
    heroSub5: "5 done. The finish line is coming into view.",
    heroTitle6: "6 of 8 — almost there",
    heroSub6: "Two more and you'll be fully prepared.",
    heroTitle7: "One left",
    heroSub7: "One more module and you're test-ready.",
  ...
  paywall: {
    ...
    benefits: [
      "Unlock Training Sets 3 & 4",
      "Unlock Practice Tests 3 & 4",
