...
export const es: TranslationKeys = {
  ...
  dashboard: {
    ...
    heroSub0: "Completa 10/10 para estar completamente preparado.",
    heroTitle1: "Primer Paso Dado",
    heroSub1: "Uno menos, siete por delante. ¡Tú puedes!",
    heroTitle2: "Tomando Impulso",
    heroSub2: "El DMV no tiene oportunidad.",
    heroTitle3: "En Racha",
    heroSub3: "¿Tres listos? Ya casi eres experto.",
    heroTitle4: "Tomando Velocidad",
    heroSub4: "Cuatro listos. Vas a buen ritmo.",
    heroTitle5: "A Medio Camino",
    heroSub5: "Bon Jovi estaría orgulloso.",
    ...
    gettingStartedComplete: "Incorporación completada",
  ...
  paywall: {
    ...
    benefits: [
      "Desbloquea el Conjunto de Entrenamiento 4",
      "Desbloquea el Examen de Práctica 4",
